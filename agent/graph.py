...
from agent.tools import consulta_financeira, processar_comprovante
...
agent = create_react_agent(model, prompt=system_message, tools=[consulta_financeira, processar_comprovante])
